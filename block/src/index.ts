...
export type MixcrClonotyping2BlockContract = BlockContract;
export type MixcrClonotyping2BlockOutputs  = BlockOutputs;
export type MixcrClonotyping2BlockData     = BlockData;
export type MixcrClonotyping2BlockHref     = BlockHref;
export const MixcrClonotyping2BlockPointer = BlockPointer;
