...
- 532cd70: Bump mixr version to 4.7.0-347-develop (switch back to default GC)
...
- 0cd5ea3: Upgrade MiXCR to 4.7.0-343-develop — packed NucleotideSequence storage for 4x memory reduction
...
- ba314b9: Upgrade MiXCR to 4.7.0-317-develop — increases JVM non-heap memory headroom to fix OOM on export
